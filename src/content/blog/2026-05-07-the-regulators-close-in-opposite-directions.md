---
title: "The Regulators Close — In Opposite Directions"
subtitle: "One week after paralysis, both continents found their footing. Brussels watered down. Washington cracked down. The pattern is convergence by contradiction."
...
1. **The EU could not enforce its own AI Act before rewriting it.** The institution corrected in the direction of least resistance. Regulatory ambition without enforcement capacity produces compliance theater. That theater still has a cover charge — and only incumbents can afford the ticket.

2. **Washington reversed its entire posture on AI governance in under a month.** The catalyst was not deliberation. It was fear — a specific model demonstrating specific capabilities that triggered a specific institutional reflex. Policy by panic is still policy. It is just not predictable policy.

3. **Microsoft published a "sovereignty checklist" the same day.** The vendor is already building the compliance product for the world the regulators are creating. When the largest infrastructure provider aligns its marketing with the regulatory frame in real time, the frame is not coming — it is here.
...
*For the preceding dispatch in this sequence, see [Forty-Five Days and Counting →](/blog/2026-05-01-forty-five-days-and-counting)*
