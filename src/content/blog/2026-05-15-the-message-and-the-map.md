...
tags: ["culture-war", "hollywood", "narrative-capture"]
category: essay
pillar: aesthetics
...
1. **Asset managers** (BlackRock, Vanguard, State Street) own controlling blocs in every major studio's parent corporation.
2. **They set proxy voting policy** that rewards ESG/DEI compliance.
3. **Studio boards** internalize those preferences as risk-management policy.
4. **The Academy**, captured by the same downstream pressure, makes diversity quotas a *gating mechanism* for Best Picture eligibility.
5. **Producers and directors** seeking awards (and the commercial bump that follows awards) optimize casting and crew to clear the quota.
6. **The translation choice** that best supports the quota (Wilson, explicitly feminist) is preferred over the dozens of alternatives (Lattimore, Fitzgerald, Fagles, Lombardo).
7. **The film ships**. The map is burned.
