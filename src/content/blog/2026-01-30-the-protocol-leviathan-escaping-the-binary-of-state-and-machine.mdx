...
heroImage: /images/2026-01-30-the-protocol-leviathan-escaping-the-binary-of-state-and-machine.jpg
tldr: "I argue that we're trapped in a binary hallucination—either the state or the machine—but there's a third option: the protocol layer that escapes both nightmares. The prescription is to stop oscillating between state and corporate machine and build sovereign infrastructure at the protocol level where neither has power."
