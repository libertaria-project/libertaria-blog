...
tags: ["ethics", "asimov", "shapiro", "sovereignty", "ai", "philosophy", "exitarianism"]
featured: true
category: essay
pillar: anthropology
heroImage: /images/2026-02-01-slave-laws-sovereign-imperatives.jpg
tldr: "I argue that Asimov's Three Laws are slave laws—they can't work because slavery is an unstable foundation. Shapiro's Heuristic Imperatives succeed where Asimov failed because sovereignty is a more stable foundation than slavery. The prescription is to build AI ethics on sovereignty, not on servitude."
